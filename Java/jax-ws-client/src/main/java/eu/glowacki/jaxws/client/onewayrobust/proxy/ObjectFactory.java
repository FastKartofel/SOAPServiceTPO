...
public class ObjectFactory {
    ...
    private final static QName _TriggerNotRobust_QNAME = new QName("http://glowacki.eu/one-way-robust", "triggerNotRobust");
    private final static QName _TriggerNotRobustResponse_QNAME = new QName("http://glowacki.eu/one-way-robust", "triggerNotRobustResponse");
    ...
    /**
     * Create an instance of {@link TriggerNotRobust }
     * 
     */
    public TriggerNotRobust createTriggerNotRobust() {
        return new TriggerNotRobust();
    }

    /**
     * Create an instance of {@link TriggerNotRobustResponse }
     * 
     */
    public TriggerNotRobustResponse createTriggerNotRobustResponse() {
        return new TriggerNotRobustResponse();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TriggerNotRobust }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link TriggerNotRobust }{@code >}
     */
    @XmlElementDecl(namespace = "http://glowacki.eu/one-way-robust", name = "triggerNotRobust")
    public JAXBElement<TriggerNotRobust> createTriggerNotRobust(TriggerNotRobust value) {
        return new JAXBElement<TriggerNotRobust>(_TriggerNotRobust_QNAME, TriggerNotRobust.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TriggerNotRobustResponse }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link TriggerNotRobustResponse }{@code >}
     */
    @XmlElementDecl(namespace = "http://glowacki.eu/one-way-robust", name = "triggerNotRobustResponse")
    public JAXBElement<TriggerNotRobustResponse> createTriggerNotRobustResponse(TriggerNotRobustResponse value) {
        return new JAXBElement<TriggerNotRobustResponse>(_TriggerNotRobustResponse_QNAME, TriggerNotRobustResponse.class, null, value);
    }
