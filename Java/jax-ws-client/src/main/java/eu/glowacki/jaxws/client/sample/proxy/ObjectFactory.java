 ...
 * generated in the eu.glowacki.jaxws.client.sample.proxy package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://glowacki.eu/sample", "add");
    private final static QName _AddResponse_QNAME = new QName("http://glowacki.eu/sample", "addResponse");
    private final static QName _Subtract_QNAME = new QName("http://glowacki.eu/sample", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://glowacki.eu/sample", "subtractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: eu.glowacki.jaxws.client.sample.proxy
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://glowacki.eu/sample", name = "add")
     ...
     */
    @XmlElementDecl(namespace = "http://glowacki.eu/sample", name = "addResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://glowacki.eu/sample", name = "subtract")
     ...
     */
    @XmlElementDecl(namespace = "http://glowacki.eu/sample", name = "subtractResponse")
